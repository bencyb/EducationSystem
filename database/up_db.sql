...
insert  into `fee`(`fee_id`,`course_id`,`fee`,`duration`,`sem`,`total_amount`) values (3,1,'36000','3','6','216000'),(4,2,'20045','3','6','120270');
...
insert  into `login`(`login_id`,`username`,`password`,`usertype`) values (1,'admin','admin','admin'),(2,'bency','bency','teacher'),(4,'bless','bless','pending');
...
insert  into `notification`(`note_id`,`notification`,`date`) values (1,'Adeddddd','2022-04-27');
...
insert  into `students`(`student_id`,`login_id`,`course_id`,`firstname`,`lastname`,`address`,`dob`,`email`,`phone`) values (2,4,1,'Blesson','Baby','Modiyil','1996-08-20','bless@gmail.com','9897899902');
...
insert  into `subjects`(`subject_id`,`course_id`,`sub_name`,`sub_description`) values (1,1,'DBMS','aww');
...
insert  into `teachers`(`teacher_id`,`login_id`,`subject_id`,`firstname`,`lastname`,`qualification`,`gender`,`email`,`phone`) values (1,2,1,'Bency','Baby','MCA','female','bency@gmail.com','9897899901');
