...
CREATE TABLE `assignments` (
  ...
  `ass_description` varchar(500) DEFAULT NULL,
...
insert  into `attendence`(`atten_id`,`teacher_id`,`student_id`,`status`,`date`) values (5,1,2,'Present','2022-05-03'),(6,1,2,'Present','2022-05-07');
...
insert  into `feedback`(`feedback_id`,`student_id`,`feedback`,`reply`,`date`) values (1,2,'Helooo....','Heyy','2022-05-02');
...
CREATE TABLE `hod` (
  ...
  `hod_address` varchar(50) DEFAULT NULL,
  `hod_phone` varchar(50) DEFAULT NULL,
  `hode_email` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`hod_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

/*Data for the table `hod` */

insert  into `hod`(`hod_id`,`login_id`,`department_id`,`hod_name`,`hod_address`,`hod_phone`,`hode_email`) values (1,6,1,'Susan Baby','                  Modiyil Blesson Villa\r\n         ','8965434321','sus@gmail.com');
...
insert  into `login`(`login_id`,`username`,`password`,`usertype`) values (1,'admin','admin','admin'),(2,'bency','bency','teacher'),(4,'bless','bless','Student'),(5,'libi','libi','teacher'),(6,'susan','susan','HOD'),(8,'anu','anu','teacher');
...
insert  into `messages`(`message_id`,`student_id`,`teacher_id`,`message`,`reply`,`date`) values (1,4,1,'assss','pending','2022-05-02 00:00:00'),(2,4,1,'sfff','pending','2022-05-03 00:00:00'),(3,2,1,'ddadad','HEyyyy','2022-05-03 00:00:00');
...
insert  into `payment`(`payment_id`,`course_id`,`student_id`,`pay_status`,`date`) values (4,1,2,'Payment Accept','2022-05-03');
...
insert  into `teachers`(`teacher_id`,`login_id`,`hod_id`,`subject_id`,`firstname`,`lastname`,`qualification`,`gender`,`email`,`phone`) values (1,2,1,1,'Bency','Baby','MCA','female','bency@gmail.com','9897899901'),(2,5,1,2,'Libin',' Mathew','PHD','male','libi@gmail.com','9196564323'),(3,8,1,1,'Anu','Elsaa','Btech','female','anu@gmail.com','8978675670');
